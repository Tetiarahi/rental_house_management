...
echo "<h2>Fix Lance Ulysses Registration Date</h2>";

// Fix the invalid date for Lance Ulysses
$result = $conn->query("UPDATE tenants SET date_in = '2024-05-01' WHERE id = 14");

if ($result) {
    echo "<p style='color: green;'>✅ Successfully updated Lance Ulysses registration date to 2024-05-01</p>";
} else {
    echo "<p style='color: red;'>❌ Failed to update registration date: " . $conn->error . "</p>";
}

// Check all dates again
echo "<h3>Updated Registration Dates</h3>";
