						...
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								...
								while($row=$tenant->fetch_assoc()):
									...
									if (empty($row['date_in']) || $row['date_in'] == '0000-00-00' || !DateTime::createFromFormat('Y-m-d', $row['date_in'])) {
								...
								<tr>
									...
									<td class="text-center">
										<?php if(!empty($row['contract_file'])): ?>
											<a href="assets/uploads/contracts/<?php echo $row['contract_file'] ?>" target="_blank" class="btn btn-sm btn-success">
												<i class="fa fa-file-pdf"></i> View Contract
											</a>
										<?php else: ?>
											<span class="badge badge-warning">No Contract</span>
										<?php endif; ?>
									</td>
									<td class="text-center">
